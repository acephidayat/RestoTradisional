...
public class GalleryActivity extends AppCompatActivity {
    ...
    private void getIncomingIntent(){
        ...
        if(getIntent().hasExtra("image_url")&& getIntent().hasExtra("image_name")){
            ...
            String mDeskripsi = getIntent().getStringExtra("description");

            setImage(imageUrl,imageName, mDeskripsi);
        }
    }

    private void setImage(String imageUrl, String imageName, String mDeskripsi){
